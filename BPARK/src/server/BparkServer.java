...
public class BparkServer extends AbstractServer {
	...
	protected void handleMessageFromClient(Object msg, ConnectionToClient client) {
		try {
			...
			if (msg instanceof String) {
				...
				// check if client ask for all orders- if there is no orders return msg, else
				// return orders
				...
				if (data.length == 4 && data[0].equals("updateOrder")) {
					...
					case 1:
						...
						client.sendToClient(new ServerResponse(true, updateOrdersForParkingSpace,
					...
					case 3:
						...
						client.sendToClient(new ServerResponse(true, updateOrdersForOrderDate,
	...
	/**
	 * This method is automatically called when a client successfully connects to
	 * the server. It retrieves and prints the client's hostname and IP address for
	 * logging purposes. This is used to fulfill the assignment requirement of
