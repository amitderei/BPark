 ...
 * Fixed parts: top bar and side-menu.  
 * The centre pane swaps screens with loadScreen().
 */
public class StaffMainLayoutController implements ClientAware {
    ...
    /**
     * Stores the staff user and hides manager-only buttons
     * when the role is Attendant.
     *
    ...
    @FXML private void handleHomeClick()   { loadScreen("/client/StaffMainScreen.fxml"); }
    ...
    @FXML private void handleRegisterUsers()      { loadScreen("/client/RegisterSubscriberScreen.fxml"); }

    @FXML private void handleViewSubscriberInfo() { loadScreen("/client/ViewSubscribersInfoScreen.fxml"); }

    @FXML private void handleViewActiveParkings() { loadScreen("/client/ViewActiveParkingsScreen.fxml"); }

    @FXML private void handleViewParkingReport() {
        UiUtils.showAlert("Report", "Viewing parking time report.", Alert.AlertType.INFORMATION);
    }

    @FXML private void handleViewSubscriberReport() {
    ...
    /**
     * Replaces the centre pane with the given FXML and passes
     * the ClientController to its controller when needed.
     *
    ...
    /**
     * Disconnects from the server (if connected) and quits.
